...
const sub_header = "Perguntas sobre o funcionamento da plataforma";
const text = [""];
...
const questions = [
  ...
  {
    question: "Posso acessar o conteúdo a hora que eu quiser?",
  ...
  {
    question: "É recomendado algum conhecimento prévio dos temas?",
  ...
  {
    question: "Como será a participação?",
